...
import psu.lionchat.textProcessing.PreProcessor;


public class MyNaiveBayesClassifier implements ClassifierIF {

	private PreProcessor textProcess; //will preprocess the user's input, stemming & punctuation removal

	public MyNaiveBayesClassifier()
	{
		textProcess = new PreProcessor();
	}
	...
	public Intent classifyUserIntent(String utterance) {
		...
		utterance = this.textProcess.process(utterance);
